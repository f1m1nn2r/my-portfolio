        ...
        <div className="about__content">
            ...
            {experience.map((item, index) => (
              <div className="experience__item" key={index}>
                <header className="experience__header">
                  ...
                  <time dateTime={item.dateTime} className="experience__period">
                    {item.period}
                  </time>
                </header>
                <ul className="experience__tasks">
                  {item.task.map((taskItem, index) => (
                    <li className="experience__task dash" key={index}>
                      {taskItem}
                    </li>
                  ))}
                </ul>
          ...
          <section className="profile">
            <article className="profile__section">
              <h3 className="profile__section-title">🔍 업무 성향</h3>
            ...
            <article className="profile__section">
              <h3 className="profile__section-title">🛠️ 기술 스택</h3>
              ...
              <div className="profile__tech-legend">
                ...
                <div className="profile__legend-item">
                  <span className="profile__legend-dot profile__legend-dot--experienced"></span>
                  <span>경험해본</span>
                </div>
              </div>
            ...
            <article className="profile__section">
              ...
              <div className="profile__section-text">
                ...
                <p className="profile__paragraph">
                  ...
                  있는데요,
                  <br /> 상의가 단순하면 하의는 독특하게, 하의가 단순하면 상의에
                  포인트를 주는 개인적인 규칙이 있습니다.
                </p>
              </div>
            </article>
          </section>
